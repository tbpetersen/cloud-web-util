...
def main():
	...
	qString = "SELECT MRID, MRASSIGNEES, MRDESCRIPTION, MRALLDESCRIPTIONS, MRSTATUS FROM FOOTPRINTS.MASTER3 where UPPER(MRASSIGNEES) LIKE '%{0}%' and MRSTATUS != '_DELETED_'".format(username.upper())
	#qString = "SELECT MRID, MRASSIGNEES, MRDESCRIPTION, MRDESCRIPTION, MRALLDESCRIPTIONS FROM FOOTPRINTS.MASTER3 where UPPER(MRASSIGNEES) LIKE '%{0}%'".format(username.upper())
